...
public class Pulsa extends AppCompatActivity implements View.OnClickListener {
    private Spinner providersp, nominalsp, hargasp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nominalsp = (Spinner) findViewById(R.id.nominalsp);
        ...
        nominalsp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {

            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                nominal = nominalsp.getSelectedItem().toString();
            }
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            Toast.makeText(Pulsa.this, "Pengiriman SMS Gagal", Toast.LENGTH_LONG).show();
            ex.printStackTrace();
        }
